...
, 'stock-sell': ['onPreEquitySell', 'onEquitySell']
, 'etf-sell': ['onEquitySell']
, 'mutfund-sell': ['onEquitySell']
, 'equity-transfer' : ['onEquityTransfer']
, 'brokerage-statement': ['onPreBrokerageStatement', 'onStatement', 'onBrokerageStatement']
, 'dividend': ['onDividend']
, 'dividend-reinvestment': ['onDividendReinvestment']
}
